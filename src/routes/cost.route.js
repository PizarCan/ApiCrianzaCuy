...
const { createCostSchema, maintenanceCostSchema } = require('../middleware/validators/costValidator.middleware');
...
router.get('/resume/:dni', awaitHandlerFactory(costController.getCostResumeByDni)); // localhost:3000/api/v1/costs/id/47238670
...
router.post('/resume', maintenanceCostSchema, awaitHandlerFactory(costController.maintenanceContributionMargin)); // localhost:3000/api/v1/costs/resume
